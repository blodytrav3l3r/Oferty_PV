import { CATEGORY_ORDER } from './pdfStyles';
import { DOCX_COLORS } from '../docx/colors';
import { fmtInt, escapeHtml, formatCurrency, formatDate, RuryOfferData } from './pdfHelpers';
import { buildContactSectionHTML } from './pdfStudnieBuilder';
...
export function buildRuryStaticTermsHTML(): string {
    return `
