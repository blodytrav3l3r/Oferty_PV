...
router.get('/', requireAuth, async (req, res) => {
    ...
    try {
        ...
        const mapped = orders.map((o) => {
            ...
            // Kolumna offerId to SSoT powiązania z ofertą. Stare klucze FK
            ...
            const fkFromBlob =
                parsedData['offerId'] ?? parsedData['offerStudnieId'] ?? parsedData['offer_id'];
            ...
            return {
                ...
                type: 'order',
                userId: o.userId,
                offerId: o.offerId ?? fkFromBlob ?? null,
                status: o.status,
...
router.post('/claim-rury-number/:userId', requireAuth, async (req, res) => {
    ...
    try {
        ...
        const idemEndpoint = 'POST /api/orders-rury/rury/claim-rury-number';
