...
check_in('zapis szerokosci po resize', 'excelColumnResize.js', r'_excelSaveColWidths')
check_in('resize na kanonicznym wierszu h1 (nie first-child)', 'excelColumnResize.js', r'headRows\[1\]|nth-child\(2\)')
