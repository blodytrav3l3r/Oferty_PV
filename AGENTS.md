...
- **Zamknięcie modala**: fizyczne usunięcie overlayu przez `_excelCloseOverlay()`, a guard `_excelClosing` chroni przed podwójnym wywołaniem. `excelSaveAll()` woła `_excelCloseOverlay()` (bez rekurencji).
