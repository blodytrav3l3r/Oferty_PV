// @ts-check
/**
 * icons-slim.js — Lekka biblioteka ikon SVG (pełne pokrycie data-lucide).
 * Zastępuje lucide.min.js (388KB) — ten plik waży ~30KB.
...
(function (global) {
    ...
    const ICONS = {
        ...
        contact: [
            '<path d="M17 18a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h2"/>',
            '<circle cx="10" cy="9" r="2"/>',
            '<path d="M14 14a3.5 3.5 0 0 0-3.5-3.5h-3A3.5 3.5 0 0 0 4 14"/>'
        ],
        copy: [
        ...
        layers: [
            ...
            '<path d="m22.54 12.43-10 4.55a2 2 0 0 1-1.07 0l-10-4.55"/>',
            '<path d="m22.54 16.43-10 4.55a2 2 0 0 1-1.07 0l-10-4.55"/>'
        ],
        link: [
        ...
        paintbrush: [
            ...
            '<path d="M9 8c-2 3-4 3.5-7 4l8 10c2-1 6-5 4-7"/>',
    ...
    // Aliasy semantycznych duplikatów (P6 ICON CONTRACT): wskazują ten sam
    // zestaw ścieżek, więc `data-lucide` ze starą nazwą renderuje się tak samo
    // jak kanoniczna. Zero zmian w plikach używających starych nazw.
    const ALIASES = {
    ...
    for (const alias in ALIASES) {
        if (ICONS[ALIASES[alias]] && !ICONS[alias]) ICONS[alias] = ICONS[ALIASES[alias]];
    }
