// @ts-check
/**
 * Pure helper functions for Kartoteka Zleceń Produkcyjnych
 * Extracted from zlecenia.js to reduce IIFE size.
 */

/* ===== DUPLICATED INNER HELPERS (extracted for DRY) ===== */

function getPowloka(po) {
    const parts = [];
...
window.buildEtykietaFromPO = buildEtykietaFromPO;
window.buildZlecenieFromPageBlock = buildZlecenieFromPageBlock;
window.buildEtykietaPageBlock = buildEtykietaPageBlock;
