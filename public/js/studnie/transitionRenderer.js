      ...
      <div style="flex:1; display:flex; justify-content:space-between; align-items:center; gap:0.5rem;">
        ...
        <div style="display:flex; align-items:center; gap:0.5rem; margin-right: 0.2rem; white-space:nowrap; flex-shrink:0;">
          <div style="width:160px; flex-shrink:0; height:54px; display:flex; flex-direction:column; justify-content:flex-start; align-items:center;">
            <div class="ui-text-muted-sm" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap; width:100%; text-align:center;" title="${spadekKLabel} [mm]">${spadekKLabel} [%]</div>
            <div data-qe-id="${item.id}" data-qe-field="spadekKineta" onclick="window.activateQuickEdit(this, ${globalIndex}, 'spadekKineta')" title="Kliknij aby edytować" style="font-size:1.0rem; font-weight:700; color:var(--text-primary); text-shadow:0 1px 2px rgba(0,0,0,0.3); cursor:pointer; padding:0.15rem 0.4rem; background:rgba(255,255,255,0.03); border-radius:4px; transition:all 0.2s; display:inline-block; margin-top:8px;" onmouseenter="this.style.color='#60a5fa'; this.style.background='rgba(255,255,255,0.1)';" onmouseleave="this.style.color='var(--text-primary)'; this.style.background='rgba(255,255,255,0.03)';">${item.spadekKineta != null && item.spadekKineta !== '' && parseFloat(item.spadekKineta) !== 0 ? Math.round(parseFloat(item.spadekKineta)) + ' %' : '—'}</div>
          </div>
          <div style="width:160px; flex-shrink:0; height:54px; display:flex; flex-direction:column; justify-content:flex-start; align-items:center;">
            <div class="ui-text-muted-sm" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap; width:100%; text-align:center;" title="${spadekMLabel} [mm]">${spadekMLabel} [%]</div>
            <div data-qe-id="${item.id}" data-qe-field="spadekMufa" onclick="window.activateQuickEdit(this, ${globalIndex}, 'spadekMufa')" title="Kliknij aby edytować" style="font-size:1.0rem; font-weight:700; color:var(--text-primary); text-shadow:0 1px 2px rgba(0,0,0,0.3); cursor:pointer; padding:0.15rem 0.4rem; background:rgba(255,255,255,0.03); border-radius:4px; transition:all 0.2s; display:inline-block; margin-top:8px;" onmouseenter="this.style.color='#60a5fa'; this.style.background='rgba(255,255,255,0.1)';" onmouseleave="this.style.color='var(--text-primary)'; this.style.background='rgba(255,255,255,0.03)';">${item.spadekMufa != null && item.spadekMufa !== '' && parseFloat(item.spadekMufa) !== 0 ? Math.round(parseFloat(item.spadekMufa)) + ' %' : '—'}</div>
          </div>
          ...
          <div style="width:105px; flex-shrink:0; height:54px; display:flex; flex-direction:column; justify-content:flex-start; align-items:center;">
            <div class="ui-text-muted-sm" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap; width:100%; text-align:center;" title="Kąt wykonania">Kąt wykonania</div>
          ...
          <div style="width:70px; flex-shrink:0; height:54px; display:flex; flex-direction:column; justify-content:flex-start; align-items:center;">
            <div class="ui-text-muted-sm" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap; width:100%; text-align:center;" title="Kąt gony">Kąt gony</div>
