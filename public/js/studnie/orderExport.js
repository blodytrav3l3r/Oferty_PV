...
window.showKartaBudowyExportChoice = function () {
    ...
    const modalHtml = `
    <div id="karta-export-modal" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(var(--black-rgb), 0.6); display: flex; justify-content: center; align-items: center; z-index: ${LAYERS.EXPORT_MODAL}; backdrop-filter: blur(4px);">
