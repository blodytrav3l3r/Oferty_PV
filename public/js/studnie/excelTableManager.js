...
// ponytail: E7 split done — undo → excelUndo.js (move-intact). Resize ZOSTAJE
// w tym pliku: wymaga tego scripts/excel-validator.py (F2: _excelSaveColWidths
// i headRows[1] muszą być w excelTableManager.js).
