...
function _excelRenderTable(dn) {
    ...
    /* === KOLUMNA 0: Checkbox - select-all przeniesiony do H2 (srodkowy) === */
    ...
    h1 += `<th style="${thBase}background:#161923;color:#94a3b8;text-align:center;width:54px;padding:2px;border-bottom:1px solid rgba(99,102,241,0.2);"><div style="display:flex;gap:2px;align-items:center;justify-content:center;">${_bulkAutoBtn}${_bulkManualBtn}</div></th>`;
    ...
    h3 += `<th style="${th3Base}background:#161923;color:#94a3b8;text-align:center;width:54px;border-right:1px solid rgba(255,255,255,0.06);"><b style="color:#fbbf24;">A/M</b></th>`;
