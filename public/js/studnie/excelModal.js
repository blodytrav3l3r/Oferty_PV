    ...
    modal.innerHTML = `
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding:0.45rem 0.8rem;background:var(--slate-950);border-bottom:1px solid rgba(var(--white-rgb), 0.05);flex-shrink:0;">
            ...
            <div style="display:flex;gap:0.4rem;align-items:center;">
                ...
                <button onclick="openPrzejsciaVisibilityPopup('excel')" class="excel-toolbar-btn tag-accent-btn" title="Pokaż/ukryj typy przejść" >Przejścia</button>
                <button onclick="openExcelShortcutsPopup()" class="excel-toolbar-btn tag-accent-btn" title="Skróty klawiszowe" >Skróty</button>
