...
(function () {
     ...
     *
     * POZYCJA HOOKA: na końcu autoSelectComponents() w wellSolver.js
     * po zaaplikowaniu configa.
     *
                ...
                return {
                    ...
                    heightFromBottomMm:
                        p.rzednaWlaczenia !== undefined && well.rzednaDna !== undefined
                            ? Math.round((parseFloat(p.rzednaWlaczenia) - parseFloat(well.rzednaDna || 0)) * 1000)
                            : undefined,
                    position: 'inline'
                };
            });
            ...
            const payload = {
                ...
                wellHeight:
                    well.rzednaDna !== undefined && well.rzednaWlazu !== undefined
                        ? Math.round(
                              (parseFloat(well.rzednaWlazu) - parseFloat(well.rzednaDna || 0)) * 1000
                          )
                        : undefined,
                wellType: well.psiaBuda ? 'psia_buda' : well.stycznaNadbudowa1200 ? 'styczna_1200' : 'standard',
                terminationType: well.zakonczenie || undefined,
                reductionType: well.redukcjaDN1000 ? 'DN' + (well.redukcjaTargetDN || 1000) : undefined,
                ...
                wasAccepted: false, // ustawione na true przez Nodelub polling patrz acceptance
                ...
                featureSnapshot: {
                    ...
                    targetHeightMm:
                        well.rzednaWlazu && well.rzednaDna !== undefined
                            ? Math.round((parseFloat(well.rzednaWlazu) - parseFloat(well.rzednaDna || 0)) * 1000)
                            : 0
                }
            };
