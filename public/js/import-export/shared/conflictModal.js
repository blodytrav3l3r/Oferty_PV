window.ConflictModal = {
    show(offerNumber) {
        return new Promise((resolve) => {
            ...
            box.style.cssText =
                'background:var(--white);border-radius: var(--radius);padding:2rem;max-width:480px;width:90%;box-shadow:0 8px 32px rgba(var(--black-rgb), 0.3);';

            box.innerHTML =
                '<h3 style="margin:0 0 0.75rem 0;font-size: var(--fs-3xl);">Konflikt numeru oferty</h3>' +
