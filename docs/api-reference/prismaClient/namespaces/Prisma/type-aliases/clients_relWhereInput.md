...
# Type Alias: clients\_relWhereInput

> **clients\_relWhereInput** = `object`

Defined in: generated/prisma/index.d.ts:40028
...
> `optional` **AND?**: `clients_relWhereInput` \| `clients_relWhereInput`[]
...
> `optional` **NOT?**: `clients_relWhereInput` \| `clients_relWhereInput`[]
...
> `optional` **OR?**: `clients_relWhereInput`[]
