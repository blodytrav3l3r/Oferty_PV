...
> **usersWhereInput** = `object`

Defined in: generated/prisma/index.d.ts:41609

## Properties

### AND?

> `optional` **AND?**: `usersWhereInput` \| `usersWhereInput`[]
...
> `optional` **NOT?**: `usersWhereInput` \| `usersWhereInput`[]
