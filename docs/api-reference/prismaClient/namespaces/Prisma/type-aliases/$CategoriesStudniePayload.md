...
Defined in: generated/prisma/index.d.ts:30263
...
> **scalars**: `$Extensions.GetPayloadResult`\<\{ `componentType`: `string` \| `null`; `name`: `string`; `order`: `number`; \}, `ExtArgs`\[`"result"`\]\[`"categoriesStudnie"`\]\>

Defined in: generated/prisma/index.d.ts:30266
