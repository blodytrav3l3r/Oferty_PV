...
# Type Alias: offer\_items\_relScalarWhereWithAggregatesInput

> **offer\_items\_relScalarWhereWithAggregatesInput** = `object`

Defined in: generated/prisma/index.d.ts:40157

## Properties

### AND?

> `optional` **AND?**: `offer_items_relScalarWhereWithAggregatesInput` \| `offer_items_relScalarWhereWithAggregatesInput`[]
...
> `optional` **NOT?**: `offer_items_relScalarWhereWithAggregatesInput` \| `offer_items_relScalarWhereWithAggregatesInput`[]
...
> `optional` **OR?**: `offer_items_relScalarWhereWithAggregatesInput`[]
