...
# Type Alias: order\_countersScalarWhereWithAggregatesInput

> **order\_countersScalarWhereWithAggregatesInput** = `object`

Defined in: generated/prisma/index.d.ts:40457

## Properties

### AND?

> `optional` **AND?**: `order_countersScalarWhereWithAggregatesInput` \| `order_countersScalarWhereWithAggregatesInput`[]
...
> `optional` **NOT?**: `order_countersScalarWhereWithAggregatesInput` \| `order_countersScalarWhereWithAggregatesInput`[]
...
> `optional` **OR?**: `order_countersScalarWhereWithAggregatesInput`[]
