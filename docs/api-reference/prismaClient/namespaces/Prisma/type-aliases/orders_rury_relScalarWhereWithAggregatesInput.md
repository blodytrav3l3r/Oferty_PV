...
# Type Alias: orders\_rury\_relScalarWhereWithAggregatesInput

> **orders\_rury\_relScalarWhereWithAggregatesInput** = `object`

Defined in: generated/prisma/index.d.ts:40613

## Properties

### AND?

> `optional` **AND?**: `orders_rury_relScalarWhereWithAggregatesInput` \| `orders_rury_relScalarWhereWithAggregatesInput`[]
...
> `optional` **NOT?**: `orders_rury_relScalarWhereWithAggregatesInput` \| `orders_rury_relScalarWhereWithAggregatesInput`[]
...
> `optional` **OR?**: `orders_rury_relScalarWhereWithAggregatesInput`[]
