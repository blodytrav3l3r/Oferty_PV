...
# Type Alias: recycled\_production\_numbersScalarWhereWithAggregatesInput

> **recycled\_production\_numbersScalarWhereWithAggregatesInput** = `object`

Defined in: generated/prisma/index.d.ts:40780

## Properties

### AND?

> `optional` **AND?**: `recycled_production_numbersScalarWhereWithAggregatesInput` \| `recycled_production_numbersScalarWhereWithAggregatesInput`[]
...
> `optional` **NOT?**: `recycled_production_numbersScalarWhereWithAggregatesInput` \| `recycled_production_numbersScalarWhereWithAggregatesInput`[]
...
> `optional` **OR?**: `recycled_production_numbersScalarWhereWithAggregatesInput`[]
