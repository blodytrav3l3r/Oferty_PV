...
# Interface: Prisma\_\_CategoriesRuryClient\<T, Null, ExtArgs, GlobalOmitOptions\>

Defined in: generated/prisma/index.d.ts:28459

The delegate class that acts as a "Promise-like" for CategoriesRury.
...
Defined in: generated/prisma/index.d.ts:28460
...
[`Subset`](../type-aliases/Subset.md)\<`T`, [`CategoriesRury$productsArgs`](../type-aliases/CategoriesRury$productsArgs.md)\<`ExtArgs`\>\>
