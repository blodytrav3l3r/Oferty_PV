...
`T` _extends_ [`Production_orders_relAggregateArgs`](../type-aliases/Production_orders_relAggregateArgs.md)\<`DefaultArgs`\>
...
> **count**\<`T`>\>(`args?`): [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`T` _extends_ `Record_2`\<`"select"`, `any`> \> ? `T`\[`"select"`\] _extends_ `true` ? `number` : \{ \[P in string \| number \| symbol\]: P extends keyof Production\_orders\_relCountAggregateOutputType ? Production\_orders\_relCountAggregateOutputType\[P\] : never \} : `number`>\>
...
`T` _extends_ [`production_orders_relCountArgs`](../type-aliases/production_orders_relCountArgs.md)\<`DefaultArgs`\>
...
[`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`T` _extends_ `Record_2`\<`"select"`, `any`\> ? `T`\[`"select"`\] _extends_ `true` ? `number` : \{ \[P in string \| number \| symbol\]: P extends keyof Production\_orders\_relCountAggregateOutputType ? Production\_orders\_relCountAggregateOutputType\[P\] : never \} : `number`\>
...
`T` _extends_ [`production_orders_relCreateArgs`](../type-aliases/production_orders_relCreateArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relCreateManyArgs`](../type-aliases/production_orders_relCreateManyArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relCreateManyAndReturnArgs`](../type-aliases/production_orders_relCreateManyAndReturnArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relDeleteArgs`](../type-aliases/production_orders_relDeleteArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relDeleteManyArgs`](../type-aliases/production_orders_relDeleteManyArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relFindFirstArgs`](../type-aliases/production_orders_relFindFirstArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relFindFirstOrThrowArgs`](../type-aliases/production_orders_relFindFirstOrThrowArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relFindManyArgs`](../type-aliases/production_orders_relFindManyArgs.md)\<`DefaultArgs`\>
...
// Only select the `id`
const production_orders_relWithIdOnly = await prisma.production_orders_rel.findMany({
    select: { id: true }
});
```
...
`T` _extends_ [`production_orders_relFindUniqueArgs`](../type-aliases/production_orders_relFindUniqueArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relFindUniqueOrThrowArgs`](../type-aliases/production_orders_relFindUniqueOrThrowArgs.md)\<`DefaultArgs`\>
...
> **groupBy**\<`T`, `HasSelectOrTake`, `OrderByArg`, `OrderFields`, `ByFields`, `ByValid`, `HavingFields`, `HavingValid`, `ByEmpty`, `InputErrors`>\>(`args`): `object` _extends_ `InputErrors` ? [`GetProduction_orders_relGroupByPayload`](../type-aliases/GetProduction_orders_relGroupByPayload.md)\<`T`> \> : [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`InputErrors`>\>
...
`T` _extends_ [`production_orders_relGroupByArgs`](../type-aliases/production_orders_relGroupByArgs.md)\<`DefaultArgs`\>
...
`object` _extends_ `InputErrors` ? [`GetProduction_orders_relGroupByPayload`](../type-aliases/GetProduction_orders_relGroupByPayload.md)\<`T`\> : [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`InputErrors`\>
...
`T` _extends_ [`production_orders_relUpdateArgs`](../type-aliases/production_orders_relUpdateArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relUpdateManyArgs`](../type-aliases/production_orders_relUpdateManyArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relUpdateManyAndReturnArgs`](../type-aliases/production_orders_relUpdateManyAndReturnArgs.md)\<`DefaultArgs`\>
...
`T` _extends_ [`production_orders_relUpsertArgs`](../type-aliases/production_orders_relUpsertArgs.md)\<`DefaultArgs`\>
