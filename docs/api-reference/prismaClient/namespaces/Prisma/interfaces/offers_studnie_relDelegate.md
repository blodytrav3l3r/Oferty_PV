...
`T` *extends* [`Offers_studnie_relAggregateArgs`](../type-aliases/Offers_studnie_relAggregateArgs.md)\<`DefaultArgs`\>
...
> **count**\<`T`\>(`args?`): [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`T` *extends* `Record_2`\<`"select"`, `any`\> ? `T`\[`"select"`\] *extends* `true` ? `number` : \{ \[P in string \| number \| symbol\]: P extends keyof Offers\_studnie\_relCountAggregateOutputType ? Offers\_studnie\_relCountAggregateOutputType\[P\] : never \} : `number`\>
...
`T` *extends* [`offers_studnie_relCountArgs`](../type-aliases/offers_studnie_relCountArgs.md)\<`DefaultArgs`\>
...
[`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`T` *extends* `Record_2`\<`"select"`, `any`\> ? `T`\[`"select"`\] *extends* `true` ? `number` : \{ \[P in string \| number \| symbol\]: P extends keyof Offers\_studnie\_relCountAggregateOutputType ? Offers\_studnie\_relCountAggregateOutputType\[P\] : never \} : `number`\>
...
`T` *extends* [`offers_studnie_relCreateArgs`](../type-aliases/offers_studnie_relCreateArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relCreateManyArgs`](../type-aliases/offers_studnie_relCreateManyArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relCreateManyAndReturnArgs`](../type-aliases/offers_studnie_relCreateManyAndReturnArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relDeleteArgs`](../type-aliases/offers_studnie_relDeleteArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relDeleteManyArgs`](../type-aliases/offers_studnie_relDeleteManyArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relFindFirstArgs`](../type-aliases/offers_studnie_relFindFirstArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relFindFirstOrThrowArgs`](../type-aliases/offers_studnie_relFindFirstOrThrowArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relFindManyArgs`](../type-aliases/offers_studnie_relFindManyArgs.md)\<`DefaultArgs`\>
...
// Only select the `id`
const offers_studnie_relWithIdOnly = await prisma.offers_studnie_rel.findMany({ select: { id: true } })
```
...
`T` *extends* [`offers_studnie_relFindUniqueArgs`](../type-aliases/offers_studnie_relFindUniqueArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relFindUniqueOrThrowArgs`](../type-aliases/offers_studnie_relFindUniqueOrThrowArgs.md)\<`DefaultArgs`\>
...
> **groupBy**\<`T`, `HasSelectOrTake`, `OrderByArg`, `OrderFields`, `ByFields`, `ByValid`, `HavingFields`, `HavingValid`, `ByEmpty`, `InputErrors`\>(`args`): `object` *extends* `InputErrors` ? [`GetOffers_studnie_relGroupByPayload`](../type-aliases/GetOffers_studnie_relGroupByPayload.md)\<`T`\> : [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`InputErrors`\>
...
`T` *extends* [`offers_studnie_relGroupByArgs`](../type-aliases/offers_studnie_relGroupByArgs.md)\<`DefaultArgs`\>
...
`ByFields` *extends* [`Offers_studnie_relScalarFieldEnum`](../type-aliases/Offers_studnie_relScalarFieldEnum.md)
...
`object` *extends* `InputErrors` ? [`GetOffers_studnie_relGroupByPayload`](../type-aliases/GetOffers_studnie_relGroupByPayload.md)\<`T`\> : [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`InputErrors`\>
...
`T` *extends* [`offers_studnie_relUpdateArgs`](../type-aliases/offers_studnie_relUpdateArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relUpdateManyArgs`](../type-aliases/offers_studnie_relUpdateManyArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relUpdateManyAndReturnArgs`](../type-aliases/offers_studnie_relUpdateManyAndReturnArgs.md)\<`DefaultArgs`\>
...
`T` *extends* [`offers_studnie_relUpsertArgs`](../type-aliases/offers_studnie_relUpsertArgs.md)\<`DefaultArgs`\>
