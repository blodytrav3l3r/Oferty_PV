...
1. 
ode -c public/js/studnie/excelHelpers.js (niezmieniany, sanity)
2. 
ode -c public/js/studnie/excelTableRenderer.js (po kroku 2)
3. 
px jest tests/studnie/excelHelpers.test.ts (krok 1 — 14 przypadków)
4. 
pm run lint:frontend
5. 
pm run typecheck:frontend
6. 
pm run format
7. **Przed commitem**: 
