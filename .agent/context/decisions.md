...
### 4. Wykrywanie zmian w zamówieniu (21.04.2026, aktualizacja 28.04.2026)
...
- **Dopłaty jako zmiana ceny (28.04.2026)**: Zmiana wartości dopłaty (`doplata`) zarówno na poziomie studni, jak i na poszczególnych przejściach (`przejscia[].doplata`) jest traktowana jako zmiana cenowa studni. Studnia z inną dopłatą na zamówieniu niż w oryginalnej ofercie jest oznaczana jako zmieniona.
  - `well.doplata` — porównanie numeryczne (wpływa na cenę dennicy)
  - `przejscia[].doplata` — uwzględniona w serializacji przejść `cleanPrzejscia()` (wpływa na cenę nadbudowy)
- *Uzasadnienie*: Zapobiega oznaczaniu studni jako "Zmieniona" tylko dlatego, że system automatycznie zastosował poprawkę techniczną. Dopłaty wpływają na cenę końcową i muszą być śledzone.
